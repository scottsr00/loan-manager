  ...
  try {
    ...
    if (activityId && activityType) {
      ...
      return histories.map((history: FacilityPositionHistoryWithRelations) => ({
        ...
        previousCommitmentAmount: history.previousCommitmentAmount,
        newCommitmentAmount: history.newCommitmentAmount,
        previousDrawnAmount: history.previousDrawnAmount,
        newDrawnAmount: history.newDrawnAmount,
